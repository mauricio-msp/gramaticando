...
--
-- Host: 127.0.0.1
-- Generation Time: 23-Nov-2015 às 22:39
...
(15, 'La vista se pierde en el horizonte', 'Es seguro ir a caminar, paso a paso.', 'un hombre que vivía en las montañas.', 'la deliciosa sensación de dignidad y libertad.', 15, 'No horizonte, advÃ©rbio de lugar.', 'Passo a passo, advÃ©rbio de modo.', 'Nas montanhas, advÃ©rbio de lugar.', 'Item correto'),
(16, 'Posiblemente voy a viajar a Sao Paulo.', 'María era aproximadamente de unos 15 años.', 'Las tareas se realizaron concurrentemente.', 'Los resultados llegaron demasiadamiente tarde.', 16, 'Possivelmente advérbio de dúvida.', 'Aproximadamente advérbio de aproximação.', 'Item correto', 'Demasiadamente é advérbio de intensidade.'),
(17, 'El sufrido tiempo no ha pasado muy rápido, infelizmente.', 'El tiempo pasó suficientemente majestuosa.', 'Realmente, el tiempo pasa demasiado rápido.', 'Sí, ha pasado el tiempo corto.', 17, 'Apenas um advérbio, infelizmente de modo.', 'Apenas um advérbio, bastante de intensidade.', 'Item correto', 'Apenas um advérbio, sim de confirmação.');
...
(15, 'Compruebe la sentencia que no tiene adverbial.', 'Uma locução adverbial ocorre quando duas,três ou mais palavras exercem função de advérbio e substantivo.', 4),
(16, 'La opción donde hay un adverbio expresar instancia de tiempo es:', 'Demasiado é um advérbio de intensidade.', 3),
(17, 'Compruebe la alternativa que se añadieron sólo adverbios a la frase: ". Ha passado el tiempo":', 'O item b tem apenas um advérbio.', 3),
(18, 'Compruebe la alternativa que se añadieron sólo adverbios a la frase: ". Pasó el tiempo":', 'O item b tem apenas um advérbio.', 3);
